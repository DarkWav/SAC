...
class SAC extends PluginBase
{
  ...
  public function onEnable()
  {
    ...
    $Logger->info(TextFormat::ESCAPE."$cl" . "[SAC] > ShadowAntiCheat v3.4.2 [ShadowX]");
    ...
    if($Config->get("Config-Version") !== "3.6.6")
    {
      $Logger->warning(TextFormat::ESCAPE."$cl"."[SAC] > Your Config is out of date!");
    }
    if($Config->get("Plugin-Version") !== "3.4.1" and $Config->get("Plugin-Version") !== "3.4.2")
    {
  ...
  public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool
  {
    ...
    {
      $sender->sendMessage(TextFormat::ESCAPE."$cl"."[SAC] > ShadowAntiCheat v3.4.2 [ShadowX] (~DarkWav/Darku)");
    }
	return false;
  }
