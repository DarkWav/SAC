...
class SAC extends PluginBase
{
  ...
  public function onEnable()
  {
    ...
    $Logger->info(TextFormat::ESCAPE."$cl" . "[SAC] > ShadowAntiCheat v3.3.9 [ShadowX]");
    ...
    if($Config->get("Plugin-Version") !== "3.3.8" and $Config->get("Plugin-Version") !== "3.3.9")
    {
  ...
  public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool
  {
    ...
    {
      $sender->sendMessage(TextFormat::ESCAPE."$cl"."[SAC] > ShadowAntiCheat v3.3.9 [ShadowX] (~DarkWav/Darku)");
    }
	return false;
  }
