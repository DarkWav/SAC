...
class SAC extends PluginBase
{
  ...
  public function onEnable()
  {
    ...
    $Logger->info(TextFormat::ESCAPE."$cl" . "<< SAC >> ShadowAntiCheat v3.5.0 [Phantom]" . TextFormat::DARK_PURPLE." @ ShadowAPI Build 1 [Phantom]");
    ...
    if($Config->get("Config-Version") !== "4.0.0")
    {
      $Logger->warning(TextFormat::ESCAPE."$cl"."<< SAC >> Your Config is out of date!");
    }
    if($Config->get("Plugin-Version") !== "3.5.0")
    {
  ...
  public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool
  {
    ...
    {
      $sender->sendMessage(TextFormat::ESCAPE."$cl"."<< SAC >> ShadowAntiCheat v3.5.0 [Phantom]" . TextFormat::DARK_PURPLE." @ ShadowAPI Build 1 [Phantom] " . TextFormat::ESCAPE ."$cl". "by DarkWav");
    }
	return false;
  }
